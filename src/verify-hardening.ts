...
applyConfigFile();
loadConfig();
const child = spawn(process.execPath, ["--test", "test/acceptance.test.ts", "test/hardening.test.ts", "test/undo.test.ts", "test/guide.test.ts", "test/work-flow.test.ts", "test/planning-process.test.ts", "test/guide-terminal.test.ts", "test/check-preparation.test.ts", "test/check-preparation-journey.test.ts", "test/check-preparation-process.test.ts", "test/guided-checks.test.ts"], { stdio: ["ignore", "pipe", "inherit"] });
let output = "";
