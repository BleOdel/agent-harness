...
export function collectAssets(url:string,options?:{timeoutMs?:number;maxResources?:number;maxBytes?:number;maxTotalBytes?:number;headers?:Record<string,string>;signal?:AbortSignal}):Promise<{responses:AssetResponse[];external:Reference[];unresolved:string[]}>;
